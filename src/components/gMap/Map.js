...
const Map = ({paths, stops})=> {
    ...
    const velocity = 100; // find km per hr
    let initialDate;
    let interval = null;
    ...
    return(
      <Card className='bg-gray-900'>
        <div className='flex items-center justify-center bg-gray-900'>
          <button  onClick={startSimulation} className="bg-[#C0C781] hover:bg-[#cbd288] text-gray-800 flex items-center  font-bold py-2 px-4 rounded">
          ...
          <g>
            ...
            <span className="ml-4">Start Simulation</span>
          </button> 
        </div>
